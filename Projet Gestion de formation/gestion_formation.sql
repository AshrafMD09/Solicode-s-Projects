...
--
-- Host: 127.0.0.1
-- Generation Time: May 18, 2023 at 10:26 AM
...
(1, 1, 'Not Valide', '2023-05-16'),
(3, 1, 'Valide', '2023-05-16'),
(5, 1, 'Valide', '2023-05-16');
...
(1, '2023-05-10', '2023-05-10', 7, 'cloturée', 1, 2),
(2, '2023-05-07', '2023-05-31', 5, 'annulée', 2, 1),
(4, '2023-05-17', '2023-05-30', 10, 'annulée', 1, 2),
(5, '2023-03-17', '2023-03-30', 20, 'annulée', 2, 1),
(6, '2023-01-17', '2023-03-23', 50, 'cloturée', 2, 1),
(7, '2023-08-02', '2023-08-04', 5, 'en cours d\'inscription', 1, 1),
(8, '2023-05-10', '2023-05-30', 6, 'annulée', 4, 2),
(9, '2023-05-10', '2023-05-29', 6, 'annulée', 5, 1),
(12, '2023-05-07', '2023-05-08', 7, 'cloturée', 8, 2),
(14, '2023-05-20', '2023-05-28', 6, 'en cours d\'inscription', 1, 1);
...
--
ALTER TABLE `session`
  MODIFY `id_session` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
