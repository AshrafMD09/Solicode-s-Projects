...
if(isset($_POST["submit"])){
  ...
  $result = mysqli_query($conn, "SELECT * FROM adherent WHERE username = '$usernameemail' OR email = '$usernameemail'");
...
<body>
    ...
    <form class="tt" action="" method="POST" autocomplete="off">
        ...
        <!-- Email input -->
        <div class="form-outline mb-4">
          <input type="text" name = "usernameemail" id = "usernameemail" class="form-control" required value="">
